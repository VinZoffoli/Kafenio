...
const roboto = Roboto({
    subsets: ["latin"],
    weight: ["600"], // solo necesitas semibold
});
...
export default function About() {
    return (
        <main>
            ...
            {/* ABOUT BRAND */}
            <section className="w-full py-[80px] bg-[url('/assets/about-fondo.webp')] bg-cover bg-center ">

                <div className="flex flex-col items-center mb-[60px]">
                    <img src="/assets/icono-aboutbrand.svg" alt="icon" className="w-[31px] h-auto mt-2" />
                </div>

                <div className="max-w-[1040px] h-[512px] mx-auto flex items-center gap-[80px]">

                    <div className="flex flex-col gap-5 max-w-[500px]">

                        <h2 className="text-[48px] leading-tight font-epitaph text-[#05589c]">
                            A MODERN SPIN ON A GREEK CLASSIC
                        </h2>

                        <p className="text-[32px] font-bold leading-[37px] font-kautiva text-[#85431a]">
                        ...
                        <a
                            href="/visit"
                            className={`${roboto.className} bg-[#04589C] text-white px-[20px] py-[10px] h-[42px] rounded-lg font-semibold text-[20px] leading-[20px] flex items-center gap-2 w-fit hover:opacity-90 transition`}
                        >
                            Visit Us Today
                    ...
                    {/* Imágenes derecha */}
                    <div className="flex flex-col gap-4 flex-1 h-[512px] ">
                        {/* Imagen grande arriba */}
                        <div className="rounded-2xl overflow-hidden h-[100%] w-[496px] group">
                            <img src="/assets/about1.webp" className="w-full h-full object-cover transition-transform duration-500 group-hover:scale-110" />
                        </div>
                        {/* Dos imágenes abajo */}
                        <div className="flex gap-4">
                            <div className="rounded-2xl overflow-hidden h-[100%] flex-1 group">
                                <img src="/assets/about2.webp" className="w-full h-full object-cover transition-transform duration-500 group-hover:scale-110" />
                            </div>
                            <div className="rounded-2xl overflow-hidden h-[100%] flex-1 group">
                                <img src="/assets/about3.webp" className="w-full h-full object-cover transition-transform duration-500 group-hover:scale-110" />
                            </div>
                        </div>
                    </div>
            ...
            {/* REVIEWS */}
            <section className="w-full py-[80px] bg-[#e5d6c2] bg-cover bg-center px-6 flex flex-col items-center text-center">

                {/* Icono */}
                <img src="/assets/Brand.svg" alt="icon" className="w-[232px] h-auto mb-4" />
                ...
                {/* Subtítulo */}
                <p className="text-[32px] leading-[37px] font-bold font-kautiva text-[#653314] mt-2">
                ...
                <a
                    ...
                    className={`${roboto.className} bg-[#04589C] text-white px-[20px] py-[10px] h-[42px] rounded-lg font-semibold text-[20px] leading-[20px] flex items-center gap-2 w-fit hover:opacity-90 transition mt-6`}
                >
                    See All Reviews
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                        <path d="M15.3025 11.0285L2 11.0285L2 8.97146L15.3025 8.97146L11.1214 4.45436L12.4872 3L19 10L12.4872 17L11.1214 15.5456L15.3025 11.0285Z" fill="white" />
                ...
                {/* Cards reviews */}
                <div className="columns-3 gap-6 mt-[48px] max-w-[1040px] w-full">
                    {[
                        {
                            name: "Natalia Santana-Pollard",
                            review: "Honestly some of the best Greek food I've had in Atlanta and I've tried a lot of places. The food was well seasoned and the portions were generous. I would've loved to try their desserts but I was so full I couldn't take another bite. Highly recommend going after lunch rush does down when it's calm and emptier.",
                        },
                        {
                            name: "Ahmad Walker",
                            review: "My first time actually getting food from here to go. Nice restaurant and ambience. They have dessert that will make your mouth water. The gyro is huge and delicious. I got a gyro with fries for dinner and a gyro platter with the salad for lunch at work the following day.",
                        },
                        {
                            name: "Dee",
                            review: "A weekday evening discovery that shall remain on the favorites list forever. Amazing Greek food, fresh flavors and no nonsense service. Where was I, missing this place for so long?",
                        },
                        {
                            name: "Alexandra Zagorski",
                            review: "Whoa, so fresh! I came here after reading the owner's response to a disgruntled customer - and I'm so glad I did! I order the Greek salad with chicken, an extra side of tzatziki and pita, and a glass of wine, all for $25 before tip. All delicious. I'll be back!",
                        },
                        {
                            name: "Stella C",
                            review: "This place have great services and have the best coffee. The food is delicious. The desserts are also tasty.\n\nUpdate: Visited recently and did I missed this so much! I relocated to the other side of town so it's a bit difficult to visit as frequently as I did in the past. As always, everything was amazing and very delicious. The staff continues to be friendly and kind. You can visit with family and friends. The coffee is GREAT!",
                        },
                        {
                            name: "Hung Do",
                            review: "Good for a quick bite of Greek food. We ordered 2 salads: Greek salad with chicken, Village salad with gyro meat. We also ordered a gyro platter with rice & side salad, & a chicken platter with potatoes & side salads. All the salads were fresh & delicious with light dressings. The potatoes were a favorite. The chicken was average. The gyro meat was good, thick cuts. The Tzatziki sauce was very good, just need more of it. Love the Arden's Garden juices. Located in Avondale Estates area.",
                        },
                        {
                            name: "Kelsey Neal",
                            review: "The staff are so friendly and patient. I have many dietary restrictions and I was carefully walked through my choices before getting the recommendation to try the Athena sandwich on pita. The plate definitely made me feel cared for like they had a Greek grandma in the back adding sliced oranges to all the plates to make sure it's properly balanced. I also love the Greek god themed decor and mural.",
                        },
                        {
                            name: "Noriko I",
                        ...
                        {
                            name: "Craig Prater",
                            review: "Came to try after driving past so many times. I stopped in and ordered the standard gyro wrap, which came with a side. I chose the rice pilaf. The portion size was great for the price. FYI, they also do breakfast if youre interested. Service was very hospitable, and the dining area looked cozy. Parking is on the street adjacent, but spots might be minimal. I'll be back for more.",
                        },
                    ].map(({ name, review }) => (
                        <div key={name} className="break-inside-avoid mb-6 bg-[#f5f5f5] rounded-2xl p-6 flex flex-col items-center text-center gap-3 shadow-md">
                            ...
                            <h3 className="text-[24px] font-bold font-kautiva text-[#363636]">{name}</h3>
                            <img src="/assets/Frame2.svg" alt="" className="w-[38px]" />
                            <p className="text-[15px] leading-[24px] text-[#3d3d3d] whitespace-pre-line">{review}</p>
                        </div>
                    ))}
                </div>
