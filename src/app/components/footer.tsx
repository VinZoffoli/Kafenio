        ...
        <footer className={`${roboto.className} w-full bg-[#011424]`}>
            ...
            <div className="w-full max-w-[1100px] mx-auto flex flex-col lg:flex-row items-center lg:items-start justify-between gap-[40px] lg:gap-[60px] py-[40px] lg:py-[60px] px-6 lg:px-0">
                ...
                <div className="flex flex-col gap-4 max-w-[580px] items-center lg:items-start text-center lg:text-left">
                    ...
                    <a
                        href="/order-online"
                        className="bg-[#04589C] text-white px-[20px] py-[10px] h-[42px] rounded-lg font-semibold text-[18px] lg:text-[20px] leading-[20px] flex items-center gap-2 w-fit hover:opacity-90 transition mt-2"
                    >
                        Order Online
                ...
                <div className="flex flex-row lg:contents gap-12 sm:gap-20 w-full justify-center lg:w-auto lg:justify-start">
                    ...
                    <div className="flex flex-col gap-3 items-start">
                        ...
                        {[
                            ...
                            <Link key={label} href={href} className={`${roboto.className} text-[#8cb2d1] text-[16px] leading-[21px] whitespace-nowrap hover:text-white transition`}>
                                {label}
                            </Link>
                        ))}
                    </div>
                    ...
                    <div className="flex flex-col gap-3 items-start">
                        ...
                        {[
                            ...
                            <Link key={label} href={href} className="text-[#8cb2d1] text-[16px] leading-[21px] whitespace-nowrap hover:text-white transition">
                                {label}
                            </Link>
                        ))}
                    </div>
