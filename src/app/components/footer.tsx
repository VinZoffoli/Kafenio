...
export default function Footer() {
    ...
    return (
        <footer className={`${roboto.className} w-full bg-[#011424]`}>
            ...
            <div className="w-[1288px] px-[76px] mx-auto flex items-start justify-between gap-[60px]  py-[60px]">

                {/* Izquierda - Logo + info */}
                <div className="flex flex-col gap-4 max-w-[580px]">
                    <img src="/assets/logofooter.svg" alt="Kafenio" className="w-[261px] mb-[20px]" />

                    <p className="text-white text-[28px] leading-[100%] font-bold mt-2">
                        Your Greek fix, anytime.
                    </p>
                    <p className="text-white text-[16px] leading-[24px] max-w-[540px]">
                        Craving a gyro or your morning latte? Order online and get your Kafenio favorites fast, fresh, easy, and ready when you are.
                    </p>
                    <p className="text-[#979797] leading-[20px] text-[14px]">
                    ...
                    <a
                        href="/order-online"
                        className="bg-[#04589C] text-white px-[20px] py-[10px] h-[42px] rounded-lg font-semibold text-[20px] leading-[20px] flex items-center gap-2 w-fit hover:opacity-90 transition mt-2"
                    >
                        Order Online
                ...
                <div className="flex flex-col gap-3">
                    ...
                    {[
                        ...
                        <Link key={label} href={href} className={`${roboto.className} text-[#8cb2d1] text-[16px] leading-[21px] hover:text-white transition`}>
                            {label}
                        </Link>
                    ))}
                </div>
                ...
                <div className="flex flex-col gap-3">
                    ...
                    {[
                        ...
                        <Link key={label} href={href} className="text-[#8cb2d1] text-[16px] leading-[21px]  hover:text-white transition">
                            {label}
                        </Link>
                    ))}
                </div>
                ...
                <div className="flex flex-col gap-4">
                    <div>
                        ...
                        <div className="flex items-center gap-3">
                            <a href="https://www.instagram.com" target="_blank" rel="noopener noreferrer" className="hover:opacity-70 transition">
                            ...
                            <a href="https://www.facebook.com" target="_blank" rel="noopener noreferrer" className="hover:opacity-70 transition">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <a href="https://www.tiktok.com" target="_blank" rel="noopener noreferrer" className="hover:opacity-70 transition">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className="w-full bg-white py-3 px-6">
                <div className="w-[1288px] px-[76px] mx-auto flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-2">
                        <a href="https://restoexp.com" target="_blank" rel="noopener noreferrer" className="flex items-center gap-1 hover:opacity-80 transition">
                            <img src="/assets/restoexplogo.webp" alt="Resto Experience" className="h-[auto] w-[307px]" />
                        </a>
                    </div>

                    {/* Right */}
                    <div className="flex items-center gap-4 text-[14px] leading-[30px] text-[#5c5c5c]">
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" width="2" height="40" viewBox="0 0 2 40" fill="none">
                            ...
                            <defs>
                                <radialGradient id="paint0_radial_2448_639" cx="0" cy="0" r="1" gradientUnits="userSpaceOnUse" gradientTransform="translate(1 20) rotate(90) scale(20 1)">
                                    <stop stop-color="#7C7C7C" stop-opacity="0.486275" />
