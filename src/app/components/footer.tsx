...
export default function Footer() {
    ...
    return (
        <footer className={`${roboto.className} w-full bg-[#011424]`}>
            ...
            <div className="w-full max-w-[1100px] mx-auto flex flex-col lg:flex-row items-center lg:items-start justify-between gap-[40px] lg:gap-[60px] py-[60px] lg:py-[90px] px-6 lg:px-0">
                ...
                <div className="flex flex-col gap-4 max-w-[580px] items-center lg:items-start text-center lg:text-left">
                    ...
                    <a
                        href="/order-online"
                        className="mt-2 w-fit h-[44px] bg-[#04589C] text-white border border-[#04589C] hover:bg-white hover:text-[#04589C] px-[20px] py-[10px] rounded-none font-semibold text-[18px] lg:text-[20px] leading-[20px] flex items-center gap-2 transition-colors"
                    >
                        Order Online
                ...
                {/* Bloque Social + Phone */}
                <div className="flex flex-col gap-4 w-full lg:w-auto bg-white/5 lg:bg-transparent p-6 lg:p-0 items-center lg:items-start text-center lg:text-left">

                    {/* Social Media */}
                    <div className="flex flex-col items-center lg:items-start">
                        <p className="text-white font-bold font-kautiva text-[18px] leading-[100%] mb-3">Social Media</p>
                        <div className="flex items-center gap-3">
                            <a href="https://www.instagram.com/kafenioavondale/" target="_blank" rel="noopener noreferrer" aria-label="Kafenio on Instagram"
                                className="w-[40px] h-[40px] border border-[#8cb2d1]/50 flex items-center justify-center hover:border-white hover:opacity-100 opacity-80 transition-all">
                            ...
                            <a href="https://www.facebook.com/kafeniogreekdiner/" target="_blank" rel="noopener noreferrer" aria-label="Kafenio on Facebook"
                                className="w-[40px] h-[40px] border border-[#8cb2d1]/50 flex items-center justify-center hover:border-white hover:opacity-100 opacity-80 transition-all">
                                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <a href="https://www.tiktok.com/@kafenioavondale" target="_blank" rel="noopener noreferrer" aria-label="Kafenio on TikTok"
                                className="w-[40px] h-[40px] border border-[#8cb2d1]/50 flex items-center justify-center hover:border-white hover:opacity-100 opacity-80 transition-all">
                                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
