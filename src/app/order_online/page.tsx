    ...
    return (
        <main>
            ...
            <section className="relative w-full h-[45vh]">
                ...
                <div className="relative z-10 flex flex-col items-center justify-center h-full text-center px-6">
                    <img
                        ...
                        alt="icono order"
                        className="w-[77px] h-auto mb-2 hero-fadein"
                    />
            ...
            <section className="w-full py-[80px] bg-[url('/assets/PreMenu.webp')] bg-cover bg-center px-6 flex flex-col items-center text-center">
                ...
                {/* Icono */}
                <img src="/assets/icono_seccion_order.svg" alt="icon" className="w-[68px] h-auto mb-4" />
                ...
                {/* Descripción */}
                <p className="text-[16px] leading-[26px] text-[#525252] max-w-[100%] mt-3">
                ...
                <p className={`${roboto.className} text-[14px] font-kautiva font-bold text-[#221c01] mt-8 uppercase`}>
                    Pickup & Delivery
                </p>
                <a
                    ...
                    className={`${roboto.className} bg-[#04589C] text-white w-[235px] h-[80px] px-[40px] py-[20px] rounded-xl font-semibold text-[20px] leading-[20px] flex items-center justify-center mt-4 hover:opacity-90 transition`}
                >
                    <svg
                        width="196"
                        height="49"
